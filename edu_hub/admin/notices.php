                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="file-upload-area" id="fileUploadArea">
                            ...
                            <p class="text-muted small">Supported formats: PDF, Images (JPG, PNG, GIF), Documents (DOC, DOCX)</p>
                    ...
                    <div class="text-center">
                        <?php if ($edit_notice): ?>
                            ...
                            <a href="notices.php" class="btn btn-secondary btn-lg">Cancel Edit</a>
                        <?php else: ?>
                ...
                <?php foreach ($notices as $notice): ?>
                    <div class="notice-card">
                        ...
                        <div class="notice-actions">
                            <a href="notices.php?edit=<?= $notice['id'] ?>" class="btn btn-outline-warning btn-sm">
